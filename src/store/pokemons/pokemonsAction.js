...
export const GET_POKEMONS_NAMES_FETCH_STATUS = 'GET_POKEMONS_NAMES_FETCH_STATUS';
export const GET_POKEMONS_NAMES_FETCH_SUCCESS = 'GET_POKEMONS_NAMES_FETCH_SUCCESS';
export const GET_POKEMONS_DETAILS_FETCH_START = 'GET_POKEMONS_DETAILS_FETCH_START';
export const GET_POKEMONS_DETAILS_FETCH_STATUS = 'GET_POKEMONS_DETAILS_FETCH_STATUS';
export const GET_POKEMONS_DETAILS_FETCH_SUCCESS = 'GET_POKEMONS_DETAILS_FETCH_SUCCESS';
